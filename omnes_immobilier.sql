...
INSERT INTO `biens_immobiliers` (`id_bien`, `type_bien`, `titre`, `description`, `ville`, `adresse`, `superficie`, `nb_pieces`, `nb_chambres`, `etage`, `balcon`, `parking`, `prix`, `photos`, `video`, `vendu`, `id_agent`, `latitude`, `longitude`) VALUES
(1, 'résidentiel', 'Maison avec jardin', 'Belle maison 4 pièces avec grand jardin', 'Paris', '12 rue Verte', 120.5, 4, 3, 0, 1, 1, 1000000, 'images/maison1.jpg', 'videos/maison1.mp4', 0, 2, 48.8566, 2.3522),
(2, 'appartement', 'Studio meublé', 'Studio meublé proche université', 'Lyon', '45 avenue des Fleurs', 28, 1, 0, 3, 0, 0, 200000, 'images/studio1.jpg', NULL, 0, 2, 45.764, 4.8357),
(3, 'terrain', 'Terrain constructible', 'Terrain à bâtir dans quartier résidentiel', 'Marseille', 'Chemin des Vignes', 500, 0, 0, 0, 0, 0, 50000, 'images/terrain1.jpg', NULL, 0, 2, 43.2965, 5.3698);
